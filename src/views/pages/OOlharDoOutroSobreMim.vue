...
export default {
  ...
  data() {
    return {
      url: "https://empreenda-se.digital/products/primeira-gestao/content/21-o-olhar-do-outro-sobre-mim/index.html",
      timeSpentOnPage: 0,
      mainTimer: null,
      alarmTimer: null,
    };
  ...
  mounted() {
    ...
    if( process.env.VUE_APP_SCORM_MODE === 'ON' )
      this.url = "content/21-o-olhar-do-outro-sobre-mim/index.html";
